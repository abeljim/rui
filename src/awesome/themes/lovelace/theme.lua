...
local gtk_colors = gtk.get_theme_variables()
local dpi = xresources.apply_dpi
local gfs = require("gears.filesystem")
local themes_path = gfs.get_themes_dir()
local rui_theme = "/usr/share/rui-desktop/awesome/themes/"
local icon_path = rui_theme .. theme_name .. "/icons/"
local layout_icon_path = rui_theme .. theme_name .. "/layout/"
local titlebar_icon_path = rui_theme .. theme_name .. "/titlebar/"
local weather_icon_path = rui_theme .. theme_name .. "/weather/"
local taglist_icon_path = rui_theme .. theme_name .. "/taglist/"
