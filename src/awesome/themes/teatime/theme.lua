...
theme.sidebar_fg = theme.xcolor11
...
theme.taglist_text_color_empty    = { theme.xcolor11, theme.xcolor11, theme.xcolor11, theme.xcolor11, theme.xcolor11, theme.xcolor11, theme.xcolor11, theme.xcolor11, theme.xcolor11, theme.xcolor11 }
...
theme.volume_bar_active_background_color = theme.xcolor8 .. "33"
...
theme.temperature_bar_background_color = theme.xcolor8 .. "33"

-- Battery bar
theme.battery_bar_active_color = theme.xcolor5
theme.battery_bar_background_color = theme.xcolor8 .. "33"

-- CPU bar
theme.cpu_bar_active_color = theme.xcolor2
theme.cpu_bar_background_color = theme.xcolor8 .. "33"

-- RAM bar
theme.ram_bar_active_color = theme.xcolor12
theme.ram_bar_background_color = theme.xcolor8 .. "33"

-- Brightness bar
theme.brightness_bar_active_color = theme.xcolor14
theme.brightness_bar_background_color = theme.xcolor8 .. "33"
